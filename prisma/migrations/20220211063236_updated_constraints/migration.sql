...
-- AlterTable
ALTER TABLE "covid_data" ALTER COLUMN "population" DROP NOT NULL;

-- AlterTable
ALTER TABLE "locations" ALTER COLUMN "latitude" DROP NOT NULL,
ALTER COLUMN "longitude" DROP NOT NULL,
ALTER COLUMN "combined_key" DROP NOT NULL,
ALTER COLUMN "population" DROP NOT NULL;

-- AlterTable
ALTER TABLE "locations_usa" ADD COLUMN     "population" INTEGER;
